      ...
      <div className="max-w-4xl mx-auto px-6 py-12">
        ...
        <div className="prose prose-lg dark:prose-invert max-w-none space-y-6 text-gray-800 dark:text-gray-200">
          <section>
            ...
            <p className="mb-4">
              Welcome to Family Trivia (&quot;we,&quot; &quot;our,&quot; or &quot;us&quot;). This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you use our mobile application and services.
            </p>
          </section>
          ...
          <section>
            ...
            <ul className="list-disc pl-6 mb-4 space-y-2">
              ...
              <li>Technical data (IP address, app crashes, performance metrics)</li>
            </ul>
          </section>
          ...
          <section>
            <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-4">4. AI-Generated Content</h2>
            <p className="mb-4">Family Trivia uses artificial intelligence to generate trivia questions and content. Please note:</p>
            <ul className="list-disc pl-6 mb-4 space-y-2">
              <li><strong>AI Limitations:</strong> AI-generated content may occasionally contain errors, inaccuracies, or inappropriate content despite our filtering efforts.</li>
              <li><strong>No Guarantees:</strong> We do not guarantee the accuracy, completeness, or appropriateness of AI-generated content.</li>
              <li><strong>User Responsibility:</strong> Users should exercise their own judgment when interacting with AI-generated content.</li>
              <li><strong>Reporting:</strong> Users can report inappropriate content through the app&apos;s reporting feature.</li>
            </ul>
          </section>
          ...
          <section>
            ...
            <ul className="list-disc pl-6 mb-4 space-y-2">
              <li><strong>Service Providers:</strong> Third-party AI providers (OpenAI, Anthropic, etc.) that help generate content</li>
              <li><strong>Analytics Partners:</strong> To understand app usage and improve services</li>
          ...
          <section>
            ...
            <p className="mb-4">
              We implement reasonable security measures to protect your information. However, no method of transmission over the internet or electronic storage is 100% secure. While we strive to protect your personal information, we cannot guarantee absolute security.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="mb-4">
              Family Trivia is designed for family use, but it is intended to be operated by users aged 13 and older. We do not knowingly collect personal information from children under 13. If you are under 13, you may not use this App. If you believe we have collected information from a child under 13, please contact us immediately and we will delete such information.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="mb-4">To exercise these rights, contact us at the email address below.</p>
          </section>

          <section>
            <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-4">9. Data Retention</h2>
            <p className="mb-4">
              We retain your personal information only as long as necessary to provide our services and comply with legal obligations. Game data and statistics may be retained for analytics purposes in anonymized form.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="mb-4">
              Email: <a href="mailto:privacy@familytrivia.app" className="text-primary hover:underline">privacy@familytrivia.app</a>
            </p>
          </section>
        </div>
      </div>
